...
class SupplierControllerTest {
    ...
    void getSupplierByIdTest() throws Exception {
        when(supplierService.getSupplierById(1)).thenReturn(Optional.of(new Supplier()));
    ...
    void getSupplierByIdNotFoundTest() throws Exception {
        when(supplierService.getSupplierById(1)).thenThrow(new ResourceNotFoundException("Supplier with id 1 not found"));
    ...
    void updateSupplierNotFoundTest() throws Exception {
        when(supplierService.supplierExists(1)).thenReturn(false);
