...
class WorkerControllerTest {
    ...
    void getWorkerByIdTest() throws Exception {
        when(workerService.getWorkerById(1)).thenReturn(Optional.of(new Worker()));
    ...
    void getWorkerByIdNotFoundTest() throws Exception {
        when(workerService.getWorkerById(1)).thenThrow(new ResourceNotFoundException("Worker with id 1 not found"));
    ...
    void createWorkerTest() throws Exception {
        when(supplierService.supplierExists(1)).thenReturn(true);
    ...
    void updateWorkerTest() throws Exception {
        when(workerService.workerExists(1)).thenReturn(true);
    ...
    void updateWorkerNotFoundTest() throws Exception {
        when(workerService.workerExists(1)).thenReturn(false);
