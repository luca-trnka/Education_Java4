...
class CustomerControllerTest {
    ...
    void getCustomerByIdTest() throws Exception {
        when(customerService.getCustomerById(1)).thenReturn(Optional.of(new Customer()));
    ...
    void getCustomerByIdNotFoundTest() throws Exception {
        when(customerService.getCustomerById(1)).thenThrow(new ResourceNotFoundException("Customer with id 1 not found"));
    ...
    void updateCustomerNotFoundTest() throws Exception {
        when(customerService.customerExists(1)).thenReturn(false);
